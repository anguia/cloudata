alter table sys_function add icon_url VARCHAR ;
alter table sys_function add menu_order INTEGER;
...
INSERT INTO "sys_function" VALUES (57, 'numAnalyze', '漫游分析', 0, 5, 0, NULL, NULL, NULL, 7);
...
INSERT INTO "sys_function" VALUES (541, 'flowAnalysisPage', '用户订购情况', 0, 54, 0, 'report/analyze/roam/roamanalyse/flowAnalysisPage.do', NULL, 'ico_business_order', 1);
...
INSERT INTO "sys_function" VALUES (611, 'PortalLog', 'portal认证日志查询', 0, 61, 0, 'report/analyze/hotspot/hostpotanalyse/HotSpotUsageMain.do', NULL, 'ico_log_protal', 1);
...
INSERT INTO "sys_function" VALUES (651, 'SelfServiceLog', '自服务日志查询', 0, 65, 0, 'report/analyze/Log/RadiusLog/RadiusLog.do', NULL, 'ico_log_self', 1);
...
insert into sys_function_url(URL_ID, FUNCTION_ID, URL, VISIBLE) values (100, 1, '/**', 'Y');
